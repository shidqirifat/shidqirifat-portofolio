  ...
  return (
    <section className="pb-20">
      ...
      <a href="mailto:rifatpangestu87@gmail.com">
        <button className="btn-contant bg-sky-500 hover:bg-sky-600 dark:bg-sky-600 dark:hover:bg-sky-500 transition-colors text-white font-semibold px-4 py-2 shadow-md rounded-md">
          Contact Me
        </button>
      </a>
    </section>
